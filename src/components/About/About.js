			...
			<>
				<div className="main-content">
					...
					<div className="description my-5">
						...
						<br/><br/>
						I love designing beautiful websites(as this one, :P). I am amazing at singing and can play the guitar and the piano. Check out my <span className="color-highlight">blog</span> and <span className="color-highlight">project</span> sections for cool stuff.
					</div>
				</div>
			</>
